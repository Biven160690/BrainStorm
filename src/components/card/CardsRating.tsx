...
export function CardsRating({ handleClickGetRating }: CardsRatingProps) {
  ...
  return (
    <Box className={flashCardRating} onClick={handleClickGetRating}>
      <Button data-rating='5' color='success' variant='outlined' size='small'>
        learnt
      </Button>
      <Button data-rating='3' color='warning' variant='outlined' size='small'>
        to repeat
      </Button>
      <Button data-rating='1' color='error' variant='outlined' size='small'>
        to learn
      </Button>
    </Box>
  );
